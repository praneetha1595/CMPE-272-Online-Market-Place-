						...
						<h2>Recently Visited</h2>
								...
								<div class="major">
													...
													<?php
														...
														if (isset($_COOKIE["fruitsflowers"]))
														{
															$i = 0;
															$temp = array();
			    ...
			    <div class="inner">
				  ...
				  <p>
                      <?php 
    					   ...
    					   $sql = "SELECT name, link, image,(review_total / review_count) as ratings FROM products WHERE store = 'fruitsflowers'order by ratings desc limit 5";
					   $result = $conn->query($sql);
    					   $conn->close();
