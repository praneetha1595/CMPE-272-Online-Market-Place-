...
<html>
	...
	<body>
		...
		?>
		<p style="margin-left: auto;margin-right: auto;width: 20em;"><span>
  		<?php 
  			if (isset($uname)) {
  			   //echo "Welcome $uname";
  			}
				...
				<section>
					<div class="inner">
						...
						<div class="major">
                                                    ...
                                                    $ch = curl_init("http://www.ketkisyoga.com/products.html");
...
<section>
					<div class="inner">
						...
						<div class="major">
                                                    ...
                                                    $ch = curl_init("http://fruits-flowers.com/products-plain.html");
                                                    curl_setopt($ch, CURLOPT_RETURNTRANSFER, true);
                                                    $op = curl_exec($ch);
                                                    $dom =  new DOMDocument;
                                                    $dom->loadHTML($op);
				...
				<section>
					<div class="inner">
						...
						<div class="major">
                                                    ...
                                                    $ch = curl_init("http://mystoreonlinehosted.com/store/products.html");
                                                    curl_setopt($ch, CURLOPT_RETURNTRANSFER, true);
                                                    $op = curl_exec($ch);
                                                    $dom =  new DOMDocument;
                                                    $dom->loadHTML($op);
				...
				<section>
					<div class="inner">
						...
						<div class="major">
                                                    ...
                                                    $ch = curl_init("http://2youfromm3.com/site/products.html");
                                                    curl_setopt($ch, CURLOPT_RETURNTRANSFER, true);
                                                    $op = curl_exec($ch);
                                                    $dom =  new DOMDocument;
                                                    $dom->loadHTML($op);
